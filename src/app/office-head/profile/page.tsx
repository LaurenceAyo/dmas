// app/office-head/profile/page.tsx
'use client'
...
// Department options (same as before)
...
export default function OfficeHeadProfilePage() {
  // Sample office-head user data
  const initialUser = {
    firstName: 'Fernan',
    lastName: 'Dematera',
    email: 'fernandimaano.dematera@bicol-u.edu.ph',
    department: 'Associate Dean Office',
    phone: '09123456789',
  }
